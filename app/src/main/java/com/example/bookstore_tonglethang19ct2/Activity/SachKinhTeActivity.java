...
public class SachKinhTeActivity extends AppCompatActivity {
    Toolbar toolbar;
    ListView listView;
    KinhTeAdapter kinhteAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sach_kinh_te);
    ...
    private void LoadMoreData() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("infomaitionBook", arrKinhTeBook.get(i));
                startActivity(intent);
            }
        });
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView absListView, int firstItem, int visibleItem, int totalItem) {
                if(firstItem + visibleItem == totalItem && totalItem != 0 && isLoading == false && limitData == false){
                    isLoading = true;
                    SachKinhTeActivity.ThreadData threadData = new SachKinhTeActivity.ThreadData();
                    threadData.start();
                }
            }
        });
                ...
                if(response != null && response.length() > 100){
                    ...
                    try {
                        ...
                        for(int i = 0; i < jsonArray.length(); i++){
                            ...
                            arrKinhTeBook.add(new Book(id, name, price, img, nhaxuatban, soluong, type, mota, idType));
                            kinhteAdapter.notifyDataSetChanged();
                        }
    ...
    private void mapping() {
        toolbar = findViewById(R.id.toolBarKinhTe);
        listView = findViewById(R.id.listViewKinhTe);
        arrKinhTeBook = new ArrayList<>();
        kinhteAdapter = new KinhTeAdapter(getApplicationContext(), arrKinhTeBook);
        listView.setAdapter(kinhteAdapter);
